...
import { PERMISSIONS_KEY, ROLES_KEY } from '../guards/role.guard'
 ...
 * }
 */
export function Permissions(...permissions: PermissionAction[]) {
 ...
 */
export function ReadOnly(resource: 'users' | 'students' | 'instructors' | 'lessons' | 'bookings' | 'payments' | 'org') {
  return Permissions(`${resource}:read` as PermissionAction)
}
 ...
 */
export function ScopedStudentAccess() {
  return (target: any, propertyKey: string, descriptor: PropertyDescriptor) => {
 ...
 */
export function ScopedLessonAccess() {
  return (target: any, propertyKey: string, descriptor: PropertyDescriptor) => {
 ...
 */
export function ScopedBookingAccess() {
  return (target: any, propertyKey: string, descriptor: PropertyDescriptor) => {
 ...
 * }
 */
export function AuthorizedEndpoint(roles?: OrgRole[], permissions?: PermissionAction[], scoped: boolean = false) {
  return (target: any, propertyKey: string, descriptor: PropertyDescriptor) => {
